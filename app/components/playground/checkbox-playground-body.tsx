...
export interface CheckboxPlaygroundBodyProps {
  variant: "full" | "embed";
}

export function CheckboxPlaygroundBody({ variant }: CheckboxPlaygroundBodyProps) {
  ...
  const knobsPanel = (
    <KnobsPanel title="Checkbox knobs" knobs={knobs} onReset={reset} getCodeSnippet={getCodeSnippet} />
  );
